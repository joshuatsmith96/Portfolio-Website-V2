...
function ProjectSection(){
    return(
        <div className="ProjectSection">
            ...
            <ProjectCard id="PC4" Title={"Portfolio Website (React, CSS, Typescript)"} Text={"View the code for this website!"} viewGithubLink="https://github.com/joshuatsmith96/budgetplanner" viewSiteLink="n" mainImage={PortfolioThumbnail}/>
            </div>
        </div>
    )
}
