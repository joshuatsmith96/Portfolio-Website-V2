...
function ProjectSection(){
    return(
        <div className="ProjectSection">
            ...
            <ProjectCard Title={"Expense Calculator (HTML, CSS, JavaScript)"} Text={""} viewGithubLink="https://github.com/joshuatsmith96/budgetplanner" viewSiteLink="https://joshuatsmith96.github.io/budgetplanner/" mainImage={TicTacToeThumbnail}/>
        </div>
    )
}
